...
<tr>
   <td>
      <a href="get-started.md">
         <img alt="Introducción" src="assets/get-started.png" />
      </a>
      <div>
          <a href="get-started.md"><strong>Introducción</strong></a>
          </div>
          <em>Aprende a navegar, usar acciones rápidas y explorar miles de plantillas diseñadas profesionalmente</em>
          <br>
   </td>
   <td>
      <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to#basic-tasks">
         <img alt="Tareas básicas" src="assets/basic-tasks.png" />
      </a>
      <div>
          <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to#basic-tasks"><strong>Tareas básicas</strong></a>
          </div>
          <em>Aprende a crear contenido que destaque de verdad</em>
        <br>
   </td>
   <td>
      <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to?#animation">
         <img alt="Animación" src="assets/animation.png" />
      </a>
      <div>
          <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to?#animation"><strong>Animación</strong></a>
          </div>
          <em>Lleva tu contenido al siguiente nivel con animaciones personalizadas</em>
        <br>
   </td>
   <td>
      ...
      <div>
          <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to#advanced-tasks"><strong>Tareas avanzadas</strong></a>
          </div>
          <em>Profundiza en la IA general, la edición para PDF y mucho más</em>
        <br>
   </td>
</tr>
<tr>
  <td>
      ...
      <div>
          ...
          <em>El vídeo es fácil. Añade vídeos y música de Adobe Stock a contenido que destaque de verdad</em>
        <br>
   </td>
   <td>
      <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to#templates">
         <img alt="Plantillas" src="assets/templates.png" />
      </a>
      <div>
          <a href="https://experienceleague.adobe.com/en/docs/creative-cloud-enterprise-learn/cce-learning-hub/expressoverview/expresshowto/overview-express-how-to#templates"><strong>Plantillas</strong></a>
          </div>
          <em>Descubre cómo aportar coherencia de marca, eficiencia y ahorros de costes a tu organización</em>
        <br>
   </td>
   <td>
      <a href="overview-express-use-case-tutorials.md">
         <img alt="Casos prácticos" src="assets/use-case-tutorials.png" />
      </a>
      <div>
          <a href="overview-express-use-case-tutorials.md"><strong>Casos prácticos</strong></a>
          </div>
          <em>Descubre cómo los diferentes equipos de tu organización pueden beneficiarse del uso de Adobe Express</em>
        <br>
   </td>
</tr>
</table>
