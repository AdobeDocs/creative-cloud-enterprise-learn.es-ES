...
<tr>
 <td>
   <a href="creativeclouddesktopapp.md#tutorial1">
      <img alt="Explora la aplicación de escritorio de CC: Tu centro para 
Creative Cloud" src="../assets/ccda_overview_sokol_thumbnail.jpg" />
   </a>
    <div>
   <a href="creativeclouddesktopapp.md#tutorial1"><strong>Explorar la aplicación de escritorio de CC: Tu centro para 
...
## Explora la aplicación de escritorio de CC: Tu centro para el Creative Cloud (2:50) {#tutorial1}
